...
try:
  while True:
      ...
      if abs(cur_error) > 5:  #eyecar had left road
          if abs(cur_error) > 10: #20
              count_for_turn +=1
              if count_for_turn > 4: #5
                  TURN = True
                  #MID_ROAD = False
                  #print("TURN")
          else:
          ...
          if cur_error > 0: #left border
              print("cur_error_left", cur_error )
              if angle > 1100 and TURN:
                  RIGHT_TURN = True
                  MID_ROAD = False
              elif angle > 1100:
                  angle-=40 #100
              ...
              print("cur_error_right", cur_error )
              if angle < 1700 and TURN:
                  LEFT_TURN = True
                  MID_ROAD = False
              elif angle < 1700:
                  angle+=40 #100
